...
<body>
<div class="back"><a href="../admin/edit admin.php" style="color:#222242;font-size:40px;"><i class="las la-arrow-left"></i></a></div>
    ...
    <div class="error"  style="color: red; margin-left:20px;" > 
        ...
        <button type="submit" name="editpassfotadmin" onclick="return confirmDelete()" > Save</button>
