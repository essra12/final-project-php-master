            ...
            <div class="inputs attach">
              ...
              <div class="container_wrapper">
                ...
                <div class="container" style="border-radius: 15px;">
                  ...
                  <a class="iframeDOC" target="_blank" href="https://docs.google.com"><i style="color: blue; font-size:20px" class="fa-regular fa-file-word"></i></a>
                  <a class="iframeDOC" target="_blank" href="https://docs.google.com/spreadsheets/u/0//"><i style="color: green;margin-left:3%; font-size:20px" class="fa-solid fa-file-excel"></i></a>
                  <a class="iframeDOC" target="_blank" href=" https://docs.google.com/presentation/u/0/"><i style="color: red;margin-left:3%; font-size:20px"   class="fa-solid fa-file-powerpoint"></i></a>               
