        ...
        <table class="table">
            ...
            <?php foreach($students as $key => $student):?> <!--هذا المتغير عبارة عن سجل واحد من الجدول $student  -->
                            <tr>
                                ...
                                <td data-label="delete"><a onclick="confirmDelete()" href="student_control_panel.php?deleteID=<?php echo $student['user_id']; ?>"><i class="las la-trash-alt ticon delet"></a></i></td>
                            </tr>
            <?php endforeach; ?> 
