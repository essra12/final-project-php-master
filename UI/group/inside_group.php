...
<body>
 ...
 <!---------------------------------------------------------->
  ...
  <div class='slider'>
   ...
   <div id='slide1' class='slide1 up1'>Materials</div>
   <div id='slide2' class='slide2'>Assignments</div>
   <div id='slide3' class='slide3'>Notification</div>
   <div id='slide4' class='slide4'>Enquiry</div>
  </div>
 </div>
