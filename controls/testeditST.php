...
if(isset($_POST['bts'])){
   ...
   /** empty التحقق من حقول الادخال باستحدام  */
    ...
    else 
    {
        ...
        $sqln="UPDATE user,student set student.stu_id=$userID, student.stu_specialization='$specialization', user.full_name='$username', user.password='$userpass1',user.u_img='$u_img'
