...
$group_no=$_SESSION['g_no'];
global $conn;
$sql="SELECT Distinct user.full_name,user.u_img,student.stu_id,post.title,post.Datatime,post.p_no,announcement.grade,post.stu_grade from user,student,student_group,post,file,announcement 
